...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            ...
            trans("lang.extra_name_placeholder")]) !!}
    ...
    <script type="text/javascript">
        ...
        var dz_var1567114747144268319ble = $(".dropzone.image").dropzone({
            ...
            init: function () {
                @if(isset($extra) && $extra->hasMedia('image'))
                dzInit(this, var1567114747144268319ble, '{!! url($extra->getFirstMediaUrl('
                    image ','
                    thumb ')) !!}')
                @endif
            },
            ...
            removedfile: function (file) {
                dzRemoveFile(
                    ...
                    'image', '{!! isset($extra) ? $extra->id : 0 !!}', '{!! url("uplaods/clear") !!}',
                    '{!! csrf_token() !!}'
                );
            }
        });
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('price', null, ['class' => 'form-control','step'=>"any",'placeholder'=>
            trans("lang.extra_price_placeholder")]) !!}
            <div class="form-text text-muted">
    ...
    <div class="form-group row ">
        {!! Form::label('extra_group_id', trans("lang.extra_extra_group_id"),['class' => 'col-3 control-label
        text-right']) !!}
        <div class="col-9">
...
<div class="form-group col-12 text-right">
    <button type="submit" class="btn btn-{{setting('theme_color')}}"><i class="fa fa-save"></i> {{trans('lang.save')}}
        {{trans('lang.extra')}}</button>
    <a href="{!! route('extras.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i>
        {{trans('lang.cancel')}}</a>
</div>